...
export default function AddTaskDialog(props) {
  ...
  return (
    <Fragment>
      <Button variant="contained" sx={{width:"25%"}} endIcon={<AddCircleOutlineIcon />} disabled={currentId === ""} onClick={handleClickOpen}>
        Add New Expense
      </Button>
      <Dialog
        open={open}
          ...
          paper: {
            ...
            onSubmit: (event) => {
              ...
              if (currentItemList.length !== 0) {
                currentItemList = [
                  ...currentItemList,
                  {
                    ...
                    cost: newItemCost,
                    itemId:
                      currentItemList[currentItemList.length - 1].itemId + 1,
                  },
                ];
              } else {
                currentItemList = [
              ...
              setBudgetList((prevlist) =>
                prevlist.filter((user) => user.dateCreated !== idCheck)
              );
